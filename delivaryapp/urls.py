...
urlpatterns = [
    ...
    path('authed/working/compliteorder/',
         views.compliteorderp, name='compliteorderp'),
    path('authed/working/compliteorder/sendorder/',
         views.sendorderp, name='sendorderp'),
    path('authed/working/compliteorder/cancel/',
         views.cancelsendingp, name='cancelsendingp'),
